...
const maps = [
  ...
  },
  {
    ...
    nodes: [
      N('phase_zero', 'PHASE 0 — source / inspect / document', 105, 4, ['root', 'phase']),
      N('gate_zero', 'GATE — boots / sensors work / cooling controllable / stock hardware stable', 105, 28, ['benchmark', 'risk']),
      N('phase_one', 'PHASE 1 — stock single-node LLM baseline', 105, 52, ['phase', 'llm']),
      N('baseline_one', 'MEASURE — model fit / prompt tok-s / generation tok-s / TTFT / watts / temps / errors', 105, 76, ['benchmark']),
      N('phase_two', 'PHASE 2 — memory + thermal + efficiency tuning', 105, 100, ['phase', 'optimization']),
      N('gate_two', 'GATE — improvement is repeatable and worth added power / complexity', 105, 124, ['benchmark']),
      N('unlock_optional', 'OPTIONAL — qualify 40-CU / 8-core paths with rollback and correctness tests', 185, 124, ['optimization', 'risk']),
      N('phase_three', 'PHASE 3 — second node', 105, 150, ['phase', 'network']),
      N('network_test', 'NETWORK TEST — dedicated 2.5 GbE backend; request sharding vs llama.cpp RPC model split', 105, 174, ['network', 'benchmark']),
      N('gate_three', 'GATE — larger-model quality or concurrency justifies second-node watts and latency', 105, 198, ['benchmark']),
      N('phase_four', 'PHASE 4 — router + specialist workers', 105, 222, ['phase', 'llm']),
      N('worker_roles', 'ROLES — fast / code / RAG-batch / speech / image / evaluation', 105, 246, ['llm']),
      N('operations', 'OPERATIONS — config management / monitoring / health / API policy / model-version inventory', 105, 270, ['software', 'benchmark']),
      N('phase_five', 'PHASE 5 — fleet or rack only if the economics still win', 105, 294, ['phase', 'cost']),
      N('fleet_gate', 'FLEET GATE — compare throughput per dollar and per watt against simpler alternative hardware', 105, 318, ['benchmark', 'alternative']),
      N('end_state', 'END STATE — measured, reproducible local AI fabric', 105, 344, ['root', 'llm']),
    ],
    edges: [
      E('e1', 'phase_zero.S', 'gate_zero.N'), E('e2', 'gate_zero.S', 'phase_one.N'), E('e3', 'phase_one.S', 'baseline_one.N'), E('e4', 'baseline_one.S', 'phase_two.N'),
      E('e5', 'phase_two.S', 'gate_two.N'), E('e6', 'gate_two.E', 'unlock_optional.W', ['optimization', 'risk']), E('e7', 'gate_two.S', 'phase_three.N'),
      E('e8', 'phase_three.S', 'network_test.N'), E('e9', 'network_test.S', 'gate_three.N'), E('e10', 'gate_three.S', 'phase_four.N'), E('e11', 'phase_four.S', 'worker_roles.N'),
      E('e12', 'worker_roles.S', 'operations.N'), E('e13', 'operations.S', 'phase_five.N'), E('e14', 'phase_five.S', 'fleet_gate.N'), E('e15', 'fleet_gate.S', 'end_state.N'),
    ],
  },
];
